...
HD_PWD='D:/desktop/vivado/first_week/first_week.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log yuhuo_men.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source yuhuo_men.tcl -notrace
