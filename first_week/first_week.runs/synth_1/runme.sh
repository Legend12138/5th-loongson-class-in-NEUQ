...
HD_PWD='D:/desktop/vivado/first_week/first_week.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yuhuo_men.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yuhuo_men.tcl
